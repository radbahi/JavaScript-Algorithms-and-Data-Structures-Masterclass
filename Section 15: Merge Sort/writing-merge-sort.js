...
function mergeSort(arr) {
    if (arr.length <= 1) { // this is to eventually return the value once the arrays are cut up until there's only one element in it
        return arr
    }
...
function merge(arr1, arr2) { // function from last lesson
    let results = []
