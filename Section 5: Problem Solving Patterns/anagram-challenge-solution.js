...
function validAnagram(str1, str2) { // my solution which works
    // add whatever parameters you deem necessary - good luck!
        if (str1.length !== str2.length) { // if not same length, obviously they can't be compared...
      ...
      for (let key in frequencyCounter1) { // for each key in frequencyCounter1
          if (!(key in frequencyCounter2)) { // if that key * 2 is not in frequencyCounter2...
              return false // ...return false
          }
          if (frequencyCounter2[key] !== frequencyCounter1[key]) { // if the count of each letter in both arrays is not the same...
              return false // ...return false
          }
      }
      return true
...
function validAnagram(first, second) { // instructor's solution, less code and more efficient
