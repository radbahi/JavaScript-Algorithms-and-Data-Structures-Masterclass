...
function search(array, val) {
    ...
    while (min <= max) {
        ...
        if (array[middle] < val) { // if middle element's value is less than inputted value...
            min = middle + 1 // ...set new min value to divide up inputted array and ignore values less than middle element's value
        } else if (array[middle] > val) { // if middle element's value is less than inputted value...
            min = middle - 1 // ...set new min value to divide up inputted array and ignore values less than middle element's value
        } else {
